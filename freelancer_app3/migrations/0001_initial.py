    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(upload_to='Freelancer_image')),
                ...
                ('availability', models.CharField(choices=[('full-time', 'Full-Time'), ('part-time', 'Part-Time'), ('hourly', 'Hourly')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estimated_time', models.PositiveIntegerField(help_text='Estimated completion time in days')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('freelnacer1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='freelancer_app3.freelancer')),
            ],
        ),
    ]
